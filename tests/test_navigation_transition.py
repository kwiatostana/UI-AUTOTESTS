...
@allure.feature("Тесты навигации и переходов")
class TestNavigationTransition:
    ...
    def test_navigation_to_lifetime_membership_page(self, opened_home_page: HomePage) -> None:
        with allure.step("Перейти на страницу через меню навигации"):
        ...
        with allure.step("Проверить заголовок h1 на странице"):
